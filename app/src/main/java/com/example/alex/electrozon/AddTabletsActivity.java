...
public class AddTabletsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productName = (EditText) findViewById(R.id.editProductT);
        productDesc = (EditText) findViewById(R.id.editDescT);
        price = (EditText) findViewById(R.id.editPriceT);
        qty = (EditText) findViewById(R.id.editQtyT);
        openDatabase();
        createProductTable();
    }
    ...
    private void createProductTable() {
        ...
        try {
            String myQuery = "CREATE TABLE IF NOT EXISTS tabletsproduct1 (\n" +
    ...
    private void insertDataToDbTable(Product product) {
        ...
        dbHomePage.insert("tabletsproduct1", null, cv);
        cv.clear();
    }
    // clear all fields
    ...
    public void btnAddProductT(View view) {
                ...
                !price.getText().toString().equals(""))
        {
            ...
            clearEditTextFields();
            Intent intent = new Intent(AddTabletsActivity.this, TabletsActivity.class);
